              ...
              <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                  {features.map((feature, index) => (
                    <motion.div
                      key={index}
                      className="group relative bg-white/5 backdrop-blur-lg rounded-2xl p-8 overflow-hidden hover:bg-white/10 transition-colors duration-300"
                      whileHover={{ y: -10 }}
                    ...
                    >
                      <motion.div
                        className="absolute inset-0 bg-gradient-to-r from-[#d9764a]/20 to-transparent"
                        initial={{ x: '-100%' }}
                        whileHover={{ x: '100%' }}
